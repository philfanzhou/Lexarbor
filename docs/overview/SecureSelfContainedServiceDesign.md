...
- `/import`: word import.
- `/import/batch`: batch word import from pasted TSV or CSV or a local UTF-8 file, parsed in the browser ([ADR-006](../adr/ADR-006-batch-import-file-formats.md)).
