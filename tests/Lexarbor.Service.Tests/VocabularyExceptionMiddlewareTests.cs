...
public class VocabularyExceptionMiddlewareTests
{
    public static TheoryData<Exception, int, string> KnownExceptions =>
        new()
        {
            ...
            { new BadHttpRequestException("Request body too large.", StatusCodes.Status413PayloadTooLarge), StatusCodes.Status413PayloadTooLarge, "The request body is too large." },
